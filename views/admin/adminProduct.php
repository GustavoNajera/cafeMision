                    ...
                    <div class="shell">
                      <div class="range range-sm-center range-75">
                        ...
                        <blockquote class="quote-review"  style="background-color: #c0a16b">
                            <form  enctype="multipart/form-data" method="POST" action="../../business/actions/ActionProduct.php?action=insert">
                        ...
                        <?php foreach ($listProduct as $product){?>
                            ...
                            <blockquote class="quote-review">
                                <form  enctype="multipart/form-data" method="POST" action="../../business/actions/actionProduct.php?action=update">
                                    ...
                                    <div class="quote-fullwidth-body">
                                        ...
                                        <div class="cell-sm-6">
                                            ...
                                            <div class="range range-sm-bottom range-15">
                                                ...
                                                <div class="cell-sm-6">
                                                  <div class="form-group">
                                                      <a href="../../business/actions/actionProduct.php?action=delete&&idproduct=<?=$product->idproduct?>&&image=<?=$product->image?>" class="btn btn-sm btn-default-size btn-danger btn-circle">Eliminar</a>
                                                  </div>
                                                </div>
