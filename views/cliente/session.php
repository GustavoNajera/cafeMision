...
<html lang="en" class="wide wow-animation">
    ...
    if ((new SessionBusiness())->getUser())
    ...
    $text2 = (new TextPageBusiness())->getTextByPageBusiness("sesion");
                ...
                <div class="shell">
                    <div class="range range-sm-center range-50">
                        <div class="cell-md-10 cell-lg-6">
                            <h3 class="text-center"><?= $text2["TituloPrincipal"] ?></h3>
                            <form method="POST" action="../../business/actions/ActionLogIn.php">
                                <div class="range range-sm-bottom range-15">
                                    <div class="cell-sm-6">
                                        <div class="form-group">
                                            <label for="billing-first-name" class="form-label-outside"><?= $text2["usuario"] ?> *</label>
                                            <input id="billing-first-name" type="text" name="user" required class="form-control">
                                        </div>
                                    </div>
                                    <div class="cell-sm-6">
                                        <div class="form-group">
                                            <label for="billing-last-name" class="form-label-outside"><?= $text2["password"] ?> *</label>
